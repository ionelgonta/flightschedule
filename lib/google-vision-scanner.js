...
exports.GoogleVisionScanner = void 0;
const vision_1 = require("@google-cloud/vision");
class GoogleVisionScanner {
    constructor() {
        this.client = null;
     ...
     */
    async scanImageForBarcodes(imageBuffer) {
        try {
     ...
     */
    async fallbackBarcodeDetection(imageBuffer) {
        try {
     ...
     */
    extractBCBPFromText(textDetections) {
...
exports.GoogleVisionScanner = GoogleVisionScanner;
exports.default = GoogleVisionScanner;
