...
export const DESTINATION_AIRPORTS: AirportData[] = [
  ...
  { code: 'VCE', city: 'Vene╚¢ia', country: 'Italia', coordinates: { lat: 45.4408, lng: 12.3155 } },
  ...
  { code: 'FLR', city: 'Floren╚¢a', country: 'Italia', coordinates: { lat: 43.7696, lng: 11.2558 } },
  ...
  // France
  { code: 'CDG', city: 'Paris', country: 'Fran╚¢a', coordinates: { lat: 48.8566, lng: 2.3522 } },
  { code: 'ORY', city: 'Paris (Orly)', country: 'Fran╚¢a', coordinates: { lat: 48.7262, lng: 2.3652 } },
  { code: 'BVA', city: 'Paris (Beauvais)', country: 'Fran╚¢a', coordinates: { lat: 49.4544, lng: 2.1128 } },
  { code: 'NCE', city: 'Nisa', country: 'Fran╚¢a', coordinates: { lat: 43.7102, lng: 7.2620 } },
  { code: 'LYS', city: 'Lyon', country: 'Fran╚¢a', coordinates: { lat: 45.7640, lng: 4.8357 } },
  { code: 'MRS', city: 'Marsilia', country: 'Fran╚¢a', coordinates: { lat: 43.2965, lng: 5.3698 } },
  ...
  // Switzerland
  { code: 'ZRH', city: 'Zurich', country: 'Elve╚¢ia', coordinates: { lat: 47.3769, lng: 8.5417 } },
  { code: 'GVA', city: 'Geneva', country: 'Elve╚¢ia', coordinates: { lat: 46.2044, lng: 6.1432 } },
  { code: 'BSL', city: 'Basel', country: 'Elve╚¢ia', coordinates: { lat: 47.5596, lng: 7.5886 } },
  ...
  // Poland
  { code: 'WAW', city: 'Var╚Öovia', country: 'Polonia', coordinates: { lat: 52.2297, lng: 21.0122 } },
  ...
  // Croatia
  { code: 'ZAG', city: 'Zagreb', country: 'Croa╚¢ia', coordinates: { lat: 45.8150, lng: 15.9819 } },
  ...
  { code: 'OTP', city: 'Bucure╚Öti', country: 'Rom├ónia', coordinates: { lat: 44.4268, lng: 26.1025 } },
  { code: 'CLJ', city: 'Cluj-Napoca', country: 'Rom├ónia', coordinates: { lat: 46.7712, lng: 23.6236 } },
  { code: 'TSR', city: 'Timi╚Öoara', country: 'Rom├ónia', coordinates: { lat: 45.7489, lng: 21.2087 } },
  { code: 'IAS', city: 'Ia╚Öi', country: 'Rom├ónia', coordinates: { lat: 47.1585, lng: 27.6014 } },
  { code: 'SBZ', city: 'Sibiu', country: 'Rom├ónia', coordinates: { lat: 45.7983, lng: 24.1256 } },
  { code: 'CRA', city: 'Craiova', country: 'Rom├ónia', coordinates: { lat: 44.3302, lng: 23.7949 } },
  { code: 'BCM', city: 'Bac─âu', country: 'Rom├ónia', coordinates: { lat: 46.5670, lng: 26.9146 } },
  { code: 'OMR', city: 'Oradea', country: 'Rom├ónia', coordinates: { lat: 47.0465, lng: 21.9189 } },
  { code: 'SCV', city: 'Suceava', country: 'Rom├ónia', coordinates: { lat: 47.6514, lng: 26.2551 } },
  { code: 'TGM', city: 'T├órgu Mure╚Ö', country: 'Rom├ónia', coordinates: { lat: 46.5386, lng: 24.5575 } },
  
  // Moldova
  { code: 'RMO', city: 'Chi╚Öin─âu', country: 'Moldova', coordinates: { lat: 47.0105, lng: 28.8638 } },
]
