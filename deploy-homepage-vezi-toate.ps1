...
Write-Host "  - Added 'Vezi toate aeroporturile' card to homepage" -ForegroundColor White
Write-Host "  - Card links to /aeroporturi page" -ForegroundColor White
Write-Host "  - Shows total airport count dynamically" -ForegroundColor White
Write-Host "  - Styled with gradient background and primary colors" -ForegroundColor White