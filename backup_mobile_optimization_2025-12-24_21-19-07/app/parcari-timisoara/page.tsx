...
export default function ParcariTimisoaraPage() {
  ...
  useEffect(() => {
    const incarcaParcari = async () => {
      try {
        ...
        // Filtrează doar parcările din Timișoara
        const parcariTimisoara = data.filter((p: Parcare) => p.oras === 'Timișoara')
        setParcari(parcariTimisoara)
      } catch (err) {
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 flex items-center justify-center gap-3">
            🅿️ Parcări Aeroport Timișoara (TSR)
          </h1>
          <p className="text-xl text-gray-700 max-w-4xl mx-auto leading-relaxed">
            Găsește cea mai potrivită parcare pentru călătoria ta din Timișoara. 
            Compară opțiunile oficiale și private pentru Aeroportul Traian Vuia Timișoara.
          </p>
        </div>
        ...
        <div className="mt-16 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-8 border border-blue-200 shadow-lg">
          <h3 className="text-2xl font-bold text-blue-900 mb-6 flex items-center gap-3">
            💡 Sfaturi Utile pentru Parcare Timișoara
          </h3>
