...
export default function ParcariBucurestiPage() {
  ...
  useEffect(() => {
    const incarcaParcari = async () => {
      try {
        ...
        // Filtrează doar parcările din București
        const parcariBucuresti = data.filter((p: Parcare) => p.oras === 'București')
        setParcari(parcariBucuresti)
      } catch (err) {
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mt-16 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-8 border border-blue-200 shadow-lg">
          <h3 className="text-2xl font-bold text-blue-900 mb-6 flex items-center gap-3">
            💡 Sfaturi Utile pentru Parcare București
          </h3>
