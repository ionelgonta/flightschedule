...
import { formatTime, formatDateInRomanian } from '@/lib/flightUtils';
          ...
          <div className="md:hidden space-y-2">
            {filteredAndSortedFlights.map((flight, index) => {
              ...
              return (
                <div
                  key={`${flight.flight_number}-${index}`}
                  className="bg-gradient-to-br from-white to-blue-50 rounded-xl border border-blue-200 shadow-md hover:shadow-lg hover:border-blue-300 transition-all duration-300 transform hover:scale-[1.01] p-3"
                >
                  {/* Compact Header - Flight Number & Status */}
                  ...
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center space-x-1 flex-1 min-w-0">
                      <span className="text-xs text-gray-500 bg-gray-100 px-2 py-1 rounded-md font-medium flex-shrink-0">
                        {relevantLocation?.code || 'N/A'}
                      </span>
                  ...
                  <div className="flex items-center justify-between pt-2 border-t border-blue-100">
                    <div className="flex items-center space-x-2">
                      <AirlineLogo 
                        airlineCode={flight.airline?.code || 'XX'} 
                        size="sm"
                        className="flex-shrink-0 ring-1 ring-white shadow-sm"
                      />
                      <div className="flex items-center space-x-2">
                        <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
                        <div className="text-lg font-bold text-gray-900">
