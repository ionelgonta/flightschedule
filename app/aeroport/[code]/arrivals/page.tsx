      ...
      <section className="px-4 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl md:text-4xl font-bold mb-2 text-white">Sosiri - {airport.city}</h1>
          ...
          <div className="lg:col-span-1 space-y-8">
            ...
            <div className="glass-card rounded-2xl p-6">
              ...
              <div className="space-y-3">
                <Link href={`/airport/${generateAirportSlug(airport)}/departures`} className="block w-full text-left px-4 py-2 bg-white/15 text-white rounded-xl hover:bg-white/25 transition-colors">Vezi Plecări</Link>
            ...
            <div className="glass-card rounded-2xl p-6">
              <h3 className="text-lg font-semibold text-white mb-4">Statistici Sosiri</h3>
              <div className="space-y-3 text-white/90">
                ...
                <div className="flex justify-between"><span>La timp</span><span className="font-semibold text-white">{flights.filter(f => f.status === 'scheduled' || f.status === 'landed' || f.status === 'arrived').length}</span></div>
