      ...
      <section className="px-4 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-xl md:text-2xl font-bold mb-2 text-white">Sosiri - {airport.city}</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="glass-card rounded-2xl p-5">
              <h3 className="text-sm font-semibold text-white mb-3">Statistici Sosiri</h3>
              <div className="space-y-2">
                ...
                <div className="flex justify-between text-xs text-white/90"><span>La timp</span><span className="font-semibold text-white">{flights.filter(f => f.status === 'scheduled' || f.status === 'active' || f.status === 'landed' || f.status === 'arrived').length}</span></div>
