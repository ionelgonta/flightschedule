...
export const metadata: Metadata = {
  title: 'Airports - Flight Schedule',
  description: 'Browse all major airports worldwide. Get real-time flight information, arrivals, and departures from international airports.',
  keywords: ['airports', 'international airports', 'flight information', 'airport codes', 'aviation'],
  openGraph: {
    title: 'Airports - Flight Schedule',
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xl text-primary-100 mb-8 max-w-3xl mx-auto">
                Browse major airports worldwide and access real-time flight information, 
                arrivals, and departures from international aviation hubs.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="lg:col-span-3 space-y-12">
              ...
              <section>
                <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    Search by airport code, city name, or country to find flight information.
                  </p>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="text-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                      ...
                      <div className="text-sm text-gray-600 dark:text-gray-400">Airports</div>
                    </div>
                    <div className="text-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                      <div className="text-2xl font-bold text-primary-600 dark:text-primary-400 mb-1">
                        50+
              ...
              <section className="prose prose-gray dark:prose-invert max-w-none">
                ...
                <div className="text-gray-600 dark:text-gray-400 space-y-4">
                  <p>
                    Our comprehensive airport directory provides access to real-time flight information 
                    from major international airports worldwide. Whether you're tracking arrivals, 
                    monitoring departures, or planning your travel, our platform offers detailed 
                    flight data from hundreds of airports across six continents.
                  </p>
                  <p>
                    Each airport page provides comprehensive information including real-time flight 
                    status, airline details, terminal and gate information, and historical data. 
                    Our advanced filtering system allows you to search by specific criteria such as 
                    airline, flight status, destination, and time range.
                  </p>
                  <p>
                    From major hubs like John F. Kennedy International Airport (JFK) in New York 
                    and London Heathrow (LHR) to regional airports serving millions of passengers 
                    annually, our database covers the world's busiest and most important aviation 
                    facilities.
                  </p>
                </div>
              </section>
