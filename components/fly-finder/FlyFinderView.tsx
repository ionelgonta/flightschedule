...
const normalizeString = (str: string): string => {
  ...
  // Note: È (charCode 200) can represent both ș and ț in corrupted data
  let fixed = str
    // Romanian characters with broken encoding - normalize all to base letters
    .replace(/È|Ș|ş|ț|Ț|ţ/gi, 's')  // Both ș and ț variants become 's' for matching
    .replace(/Ä|Äƒ|ă/gi, 'a')        // ă variants (Ä = charCode 196)
    .replace(/Ã¢|â/gi, 'a')          // â variants
    .replace(/Ã®|î/gi, 'i')          // î variants
...
const CITY_IATA_CODES: Record<string, string> = {
  ...
  'male': 'MLE', 'maldive': 'MLE', 'maldives': 'MLE', 'malé': 'MLE',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="mt-8 grid md:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            ...
            <p className="text-sm text-gray-600">
              Filtrează după dimineață, amiază sau seară. Perfect pentru a găsi zboruri care se potrivesc programului tău.
            </p>
          </div>
