              ...
              {isAnalyticsOpen && (
                <div className="absolute top-full left-0 mt-1 w-64 bg-white rounded-lg shadow-lg border border-gray-200 py-1 z-50">
                  ...
                  >
                    ...
                    <div className="text-xs text-gray-500">Performanță și punctualitate</div>
                  </Link>
                  <Link
                  ...
                  >
                    ...
                    <div className="text-xs text-gray-500">Calendar interactiv</div>
                  </Link>
                  <Link
                    href="/statistici"
                    className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors"
                  ...
                  >
                    ...
                    <div className="text-xs text-gray-500">Date istorice și tendințe</div>
                  </Link>
                  <Link
                  ...
                  >
                    ...
                    <div className="text-xs text-gray-500">Tendințe și evoluție</div>
                  </Link>
                  <Link
                    href="/analize-rute"
                    className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors"
                  ...
                  >
                    ...
                    <div className="text-xs text-gray-500">Rute și companii aeriene</div>
                  </Link>
                  ...
                  >
                    ...
                    <div className="text-xs text-gray-500">Căutare ICAO24 și înmatriculare</div>
                  </Link>
                </div>
              )}
            </div>
          ...
          <div className="md:hidden py-4 border-t border-gray-200">
            <div className="flex flex-col space-y-1">
              ...
              <div className="bg-gray-50 rounded-lg p-3 my-2">
                <div className="text-sm font-medium text-blue-600 flex items-center mb-2">
