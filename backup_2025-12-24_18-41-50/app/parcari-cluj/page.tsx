...
export default function ParcariClujPage() {
  ...
  useEffect(() => {
    const incarcaParcari = async () => {
      try {
        ...
        // Filtrează doar parcările din Cluj-Napoca
        const parcariCluj = data.filter((p: Parcare) => p.oras === 'Cluj-Napoca')
        setParcari(parcariCluj)
      } catch (err) {
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-700 max-w-4xl mx-auto leading-relaxed">
            ...
            Compară opțiunile oficiale și private pentru Aeroportul Avram Iancu Cluj.
          </p>
        </div>
        ...
        <div className="mt-16 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-8 border border-blue-200 shadow-lg">
          <h3 className="text-2xl font-bold text-blue-900 mb-6 flex items-center gap-3">
            💡 Sfaturi Utile pentru Parcare Cluj-Napoca
          </h3>
