...
Write-Host "=== TEST SERVER API (www.zbor.md) ===" -ForegroundColor Cyan
Write-Host ""

# Test API endpoints pe server cu www
$endpoints = @(
    "https://www.zbor.md/api/flights/OTP/arrivals",
    "https://www.zbor.md/api/flights/OTP/departures"
)
